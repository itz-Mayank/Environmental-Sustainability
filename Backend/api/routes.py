...
# At the top of routes.py, modify the imports
...
# Modify the initialization of services
@api.before_request
def before_request():
    # You can access the config from the current app's config
    config = {
    ...
    global data_fetcher, data_processor, aqi_model, wqi_model, alert_service
